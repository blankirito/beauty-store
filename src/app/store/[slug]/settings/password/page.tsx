...
import StorefrontPasswordSettingsPage from "@/components/storefront/StorefrontPasswordSettingsPage";
import { createClient } from "@/lib/supabase/server";
import { getCachedPublicStorefront } from "@/lib/storefront/publicStorefrontCache";

type StorefrontPasswordSettingsRouteProps = {
  params: Promise<{
    slug: string;
  }>;
};

export default async function StorefrontPasswordSettingsRoute({
  params,
}: StorefrontPasswordSettingsRouteProps) {
  ...
  return (
    <StorefrontPasswordSettingsPage
      storeName={storefront.name}
      storeSlug={storefront.slug}
    />
  );
